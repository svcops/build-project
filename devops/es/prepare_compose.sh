#!/bin/bash
# shellcheck disable=SC1090 disable=SC2086 disable=SC2155 disable=SC2128 disable=SC2028 disable=SC2164 disable=SC2162
...
read -p "Confirm prepare es's files in $current_dir" answer
